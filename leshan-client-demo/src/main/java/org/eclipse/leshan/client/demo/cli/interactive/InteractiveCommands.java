...
public class InteractiveCommands implements Runnable, JLineInteractiveCommands {
    ...
    static class SendCommand implements Runnable {
        ...
        @Parameters(description = "paths of data to send.")
        private List<String> paths;

        @Option(names = { "-c", "--content-format" }, description = "Content Format used to send data")
        ...
        public void run() {
            ...
            for (final ServerIdentity server : registeredServers.values()) {
                ...
                parent.client.sendData(server, ContentFormat.SENML_CBOR, paths, 2000,
